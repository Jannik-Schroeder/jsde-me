...
export const getServerSideProps = async () => {
  const response = await fetch(
    'https://api.openweathermap.org/data/2.5/weather?lat=51.716667&lon=8.766667&appid=33e44e8486adca6d827a20492afc160f&units=metric'
  )
        ...
        <div>
          <div className="flex justify-between gap-5">
            <div className="mt-2 mb-10 w-1/2 rounded-md border border-gray-600 p-1 text-sm dark:border-gray-200">
              <span className="ml-2 font-semibold">Location:</span> <span>Paderborn, Germany</span>
              <br />
              <span className="ml-2 font-semibold">Weather:</span>{' '}
              <span>
                <a
                  href="https://weather.com/en-GB/weather/today/l/38fc30e378d88974ea790714aad59853328b10fd2375312c96954e2590b4c9e1"
                  target="_blank"
            ...
            <div className="mt-2 mb-10 w-1/2 rounded-md border border-gray-600 p-1 text-sm dark:border-gray-200">
              <span className="ml-2 font-semibold">Interests:</span> Martial Arts
              <br />
          ...
          <div className="-my-6 flex justify-between gap-5">
            <div className="mt-2 mb-10 w-1/2 rounded-md border border-gray-600 p-1 text-sm dark:border-gray-200">
              ...
              <span>
                <BsClock className="mb-0.5 inline h-3 w-3 hover:animate-spin" /> {hour}:{minute}:
                {second}
              </span>
            </div>
