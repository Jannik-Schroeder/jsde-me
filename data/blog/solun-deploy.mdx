...
title: Solun Deploy
date: '2023-08-18'
tags: ['Solun', 'deploy', 'docker']
draft: false
summary: In this article we will look at how to deploy solun and save ourselves most of the work. But at the same time we also want to have a good visible version history that we manage via Discord.
images: []
layout: PostLayout
canonicalUrl:
---
