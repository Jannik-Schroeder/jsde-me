...
date: '2023-10-15'
tags: [Proxmox, Cloud-Init, Debian]
draft: false
summary: Create a Debian 12 Cloud-Init template for Proxmox VE
images: []
layout: PostSimple
---
...
<img className="inline" src="/static/images/snippets/disk-settings-cloud-init.png" alt="Disk Settings" />
