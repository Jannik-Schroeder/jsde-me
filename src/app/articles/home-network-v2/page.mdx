...
{/* TODO: Add image of server rack with new setup */}
<div style={{ padding: '40px', background: 'var(--tw-prose-pre-bg)', borderRadius: '8px', textAlign: 'center', margin: '20px 0' }}>
    <p style={{ color: 'var(--tw-prose-body)', margin: 0 }}>📷 Server Rack Image Placeholder</p>
    <p style={{ color: 'var(--tw-prose-body)', fontSize: '0.875rem', margin: '8px 0 0 0' }}>Images of the new UniFi setup coming soon</p>
</div>
